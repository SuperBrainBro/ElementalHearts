...
namespace ElementalHearts.Items.Consumables.Bosses.CrossMod
{
    internal class BloodyWormHeart : ModItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            DisplayName.SetDefault("Bloody Worm Heart");
        }
        ...
        {
            return player.statLifeMax >= 100 && player.GetModPlayer<ElementalHeartsPlayer>().BloodyWormLife <
        ...
        public override bool UseItem(Player player)
        {
            ...
            player.GetModPlayer<ElementalHeartsPlayer>().BloodyWormLife += 1;
            return true;
        }
    }
}
